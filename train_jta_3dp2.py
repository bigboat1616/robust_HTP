...
if __name__ == "__main__":
    ...
    # torch.backends.cuda.matmul.allow_tf32 = False # True: faster, False: more deterministic
    # torch.backends.cudnn.allow_tf32 = False      # True: faster, False: more deterministic
    torch.backends.cudnn.benchmark = False       # True: faster, False: more deterministic
    torch.backends.cudnn.deterministic = True  # True: more deterministic, False: faster
    torch.use_deterministic_algorithms(True) # True: more deterministic, False: faster
