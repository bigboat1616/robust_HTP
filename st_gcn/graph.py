...
class Graph():
    ...
    def get_edge(self, layout):
        ...
        if layout == 'openpose':
            ...
            self.edge = self_link + neighbor_link
            self.center = 2  # neck as center
        elif layout == 'jta_3dp_row':
            self.num_node = 22
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_link = [
                # Head
            ...
            self.num_node = 17
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_1base = [[1, 2], [0, 4], [3, 4], [8, 10], [5, 7], [10, 13], 
                              [14, 16], [4, 5], [7, 12], [4, 8], [3, 6], [13, 15], 
                              [11, 14], [6, 9], [8, 11]]
